...
import { createField, getFieldById, updateField,deleteFieldById } from 'services/danhmuc.service';
...
const Fields2 = () => {
    ...
    useEffect(() => {
        request('/api/field').then((response) => {
            ...
            <div className="w-full mx-auto py-10">
                ...
                <table className=" border-collapse w-full ">
                    <thead className='bg-slate-300' >
                        <tr>
                            <th className="border border-slate-300 bg-slate-300 ">STT</th>
                            <th className="border border-slate-300 bg-slate-300 ">Controll</th>
                            <th className="border border-slate-300 bg-slate-300 ">Ma nganh</th>
                            <th className="border border-slate-300 bg-slate-300 ">Nganh nghe</th>
                        ...
                        {data &&
                            data.map((item, index) => (
                                <tr key={index}>
                                    ...
                                    <td className='border border-slate-300 flex flex-row gap-x-4'>
                                        <div className="mx-auto dropdown">
                                            ...
                                            <div className="child bg-white z-10">
                                                ...
                                                <div onClick={()=>handleDeleteFilde(item.id)} className="p-2 bg-white cursor-pointer hover:bg-gray-100 w-20">
                                                    Xóa
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    <td className='border border-slate-300'>{item.code}</td>
