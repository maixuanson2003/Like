...
const Course2 = () => {
  ...
  const [idcoures, setIdCourse] = useState();
  ...
  const updateCourseid = () => {
    ...
    updateCourse(idcoures, dataset).then((res) => {
      handleClose();
      setRender(Date.now());
    });
  };
      ...
      <table className="w-full  ">
        <thead>
          <tr className="border border-[#eee] bg-[#F0F0F0]">
            ...
            <th className="border border-slate-300 bg-slate-300">Tên khóa</th>
            <th className="border border-slate-300 bg-slate-300">
              Năm bắt đầu
            </th>
          </tr>
        </thead>
                ...
                <td className="border border-slate-300 bg-slate-300 flex flex-row">
                  <div className="mx-auto dropdown">
                    ...
                    <div className="child bg-white z-10">
                      ...
                      <div
                        onClick={() => deleteCourseById(item.id)}
                        className="p-2 bg-white cursor-pointer hover:bg-gray-100 w-20"
                      >
                        Xóa
                      </div>
