...
import { createCourse, deleteCourseById, getCourseById, updateCourse } from 'services/danhmuc.service';
...
const Course = () => {
    ...
    const handleUpdate = () => {
        ...
        updateCourse(dataEdit.id,params).then(res=>{
            handleClose();
            setRender(Date.now())
        })
    }
        ...
        <table className="w-full">
          <thead>
            <tr className="border border-[#eee] bg-[#F0F0F0]">
              ...
              <th className="border p-2">Tên khóa</th>
              <th className="border p-2">Năm bắt đầu</th>
            </tr>
          </thead>
          <tbody>
            <tr></tr>
                ...
                <td className="border border-[#eee] text-center p-3">
                  <div className="mx-auto dropdown">
                    ...
                    <div className="child bg-white z-10">
                      ...
                      <div className="p-2 bg-white cursor-pointer hover:bg-gray-100 w-20" onClick={()=>{
      ...
      >
        <div className="py-6 px-12 flex gap-x-10">
          <div className="w-full">
            <div className="font-bold">Tên khóa</div>
            <div className="mt-2 w-full">
              <input
                className="border px-4 py-2 rounded w-full"
                placeholder="Tên khóa"
                onChange={(e) => {
          ...
          <div className="w-full">
            <div className="font-bold">Năm bắt đầu</div>
            <div className="mt-2 w-full">
              <input
                type="number"
                className="border px-4 py-2 rounded w-full"
